...
public class Correo
{
    ...
    public void enviarCorreo(String correoDestino, String userToken, String mensaje)
    {
        ...
        try
        {
            var Emailtemplate = new System.IO.StreamReader(AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, "GitHub\\ultimo\\Motobombas\\Plantilla\\mailer.html"));
